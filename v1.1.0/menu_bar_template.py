...
class HelpDialog(QDialog):
    def __init__(self):
        ...
        help_text = r"""
            ...
            <h2><span style="color: #FFFFFF;">📝 Version: 1.1.0</span></h2>
            ...
            <strong><span style="color: #000000; background-color: yellow;">"Promptiverse"</span></strong>
            - the ultimate prompt manager!
            <br>With its user-friendly interface, you can effortlessly add, edit, delete, and search prompts.
            <br>Let your creativity soar with Promptiverse!
            </span></p>

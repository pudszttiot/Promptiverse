...
class PromptManager(QWidget):
    ...
    def initUI(self):
        ...
        self.setGeometry(650, 300, 780, 600)
        ...
        # Clear Button for Display Section
        self.clear_button_display = QPushButton("Clear Display")
        ...
        # Create context menu for prompt list
    ...
    def show_context_menu(self, position):
        context_menu = QMenu()
        context_menu.setStyleSheet(STYLESHEET)  # Apply stylesheet directly to the context menu
